...
########################## Environment_lane Class ##############################
# Environment classes provide functions for maintaining agents, the environment, 
# and the interaction between them
# Environment_lane represents the one-lane world environment where agents moving
# in opposite directions must cross a one-lane bridge without collision
class Environment_lane():
    ...
    # inputs:
        # moves - 1 x num_agents list of moves (ints from 0-1) 
