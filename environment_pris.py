...
class Environment_pris():
    ...
    def __init__(self, stochastic, agent_params):
        ...
        self.rewards[:,0] = np.asarray([10, 0, 0, 0])
        self.rewards[:,1] = np.asarray([0,  1, 6, 3])
        self.rewards[:,2] = np.asarray([0,  6, 4, 8])
        self.rewards[:,3] = np.asarray([0,  3, 8, 4])
    ...
    def get_reward(self):
        ...
        if self.stochastic and self.rewards == 1:
            if random.rand() < 0.01:
                self.reward = 100
        return reward
